...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run multiple NEW_TSSP_M1_*.py scripts sequentially")
    parser.add_argument('-p', '--pattern', default='NEW_TSSP_M1_*.py', help='glob pattern to match scripts')
