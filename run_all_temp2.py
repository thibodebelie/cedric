...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run multiple TSSP_NEWM2_temp_*.py scripts sequentially")
    parser.add_argument('-p', '--pattern', default='TSSP_NEWM2_temp_*.py', help='glob pattern to match scripts')
